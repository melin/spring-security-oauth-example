...
<%@page import="com.github.melin.rest.UserServiceClientUtil"%>
...
<body>
	...
	<%
		...
		if(StringUtils.hasText(code)) {
			if(session.getAttribute("result") == null) {
		        ...
		        form.add("redirect_uri", "http://localhost:8090/SpringRest/");
		        ...
		        out.print("</br></br>调用服务接口结果：http://localhost:8090/SpringRest/api, method = user.getSession </br><textarea rows='5' cols='100'>" + repo + "</textarea>");
	...
	%>
		<a href="http://localhost:8080/Oauth2Server/oauth/authorize?client_id=af4sdop16&response_type=code&scope=read&state=123456&redirect_uri=http://localhost:8090/SpringRest/">获取authcode</a>
	<%}%>
</body>
</html>
